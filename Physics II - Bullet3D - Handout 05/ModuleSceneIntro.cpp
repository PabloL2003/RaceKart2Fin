...
bool ModuleSceneIntro::Start()
{
	...
	addCube({ -54,0,-86 }, { 6.5f,0.3f,30 }, { 1,1,1 }, 0, -135, 0);
	addCube({ -40,0,-75 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -105, 0);
	addCube({ -23,0,-73.5f }, { 6.5f,0.3f,30 }, { 1,1,1 }, 0, -90, 0);
	addCube({ -4,0,-75 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -75, 0);
	addCube({ 3,0,-79 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -45, 0);
	addCube({ 9,0,-87 }, { 6.5f,0.3f,30 }, { 1,1,1 }, 0, -35, 0);
	addCube({ 23,0,-102 }, { 6.5f,0.3f,15 }, { 1,1,1 }, 0, -65, 0); 
	addCube({ 38,0,-104 }, { 6.5f,0.3f,25 }, { 1,1,1 }, 0, -90, 0);
	addCube({ 53,0,-102 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -120, 0);
	addCube({ 58,0,-96 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -150, 0);
	addCube({ 60,0,-88 }, { 6.5f,0.3f,10 }, { 1,1,1 }, 0, -175, 0);
	addCube({ 18,0,-42.5f }, { 8,0.3f,120 }, { 1,1,1 }, 0, -225, 0);
	addCube({ -25,0,3 }, { 10,0.3f,10 }, { 1,1,1 }, 0, -195, 0);
	addCube({ -26,0,16 }, { 10,0.3f,25 }, { 1,1,1 }, 0, -180, 0);
	addCube({ -24,0,30 }, { 9,0.3f,10 }, { 1,1,1 }, 0, -155, 0);
	addCube({ -20,0,35 }, { 9,0.3f,10 }, { 1,1,1 }, 0, -120, 0);
	addCube({ 12,0,36 }, { 9,0.3f,65 }, { 1,1,1 }, 0, -90, 0);
	addCube({ 47,0,38 }, { 9,0.3f,10 }, { 1,1,1 }, 0, -120, 0);
	addCube({ 53.5f,0,45 }, { 9,0.3f,15 }, { 1,1,1 }, 0, -145, 0);
	addCube({ 59,0,56 }, { 9,0.3f,15 }, { 1,1,1 }, 0, -160, 0);
	addCube({ 61,0,75 }, { 9,0.3f,30 }, { 1,1,1 }, 0, -180, 0);
	addCube({ 59,0,92 }, { 9,0.3f,10 }, { 1,1,1 }, 0, -210, 0);
	addCube({ 54,0,99 }, { 9,0.3f,10 }, { 1,1,1 }, 0, -230, 0);
